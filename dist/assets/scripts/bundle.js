...
var InitializeApp = (function () {
    ...
    InitializeApp.prototype.initializeVariables = function () {
        this.durations = {
            normal: 300,
            appearance: 450,
            animation: 900
    ...
    InitializeApp.prototype.toggleSideNavigation = function () {
        ...
        var $toggleTrigger = $('#jsi-jnl-navigation__trigger');
        var defaultClassName = 'jnl-navigation';
        var openedClassName = 'jnl-navigation--opened';
    ...
    InitializeApp.prototype.insertArrowToMenu = function () {
        var $lists = $('.jsc-jnl-layout__contents__pages__list');
        var $rightArrow = "<i class=\"jnl-icon\">keyboard_arrow_right</i>";
        $lists.each(function () {
    ...
    InitializeApp.prototype.isPaneShown = function (pane) {
        ...
        var navigationWidth = $('#jsi-jnl-navigation').innerWidth();
        return parseInt(pane.css('left'), 10) != windowWidth - navigationWidth;
    };
    InitializeApp.prototype.posiotioningPanes = function () {
        var _this = this;
        var $main = $('#jsi-jnl-layout__contents');
        var $paneLinks = $('a[data-pane-href]');
        var $panes = $main.children();
        var $paneHeaders = $('.jsc-layout__pane__headline');
        var windowWidth = $(window).width();
        var navigation = $('#jsi-jnl-navigation');
        var paneCloseClassName = 'jsc-jnl-layout__pane__headline__close';
        /**
        ...
        **/
        $paneHeaders.each(function () {
            var $closingButton = "<i class=\"jnl-icon " + paneCloseClassName + "\">close</i>";
    ...
    InitializeApp.prototype.adjustPanePosition = function () {
        //   TODO: WIP...
